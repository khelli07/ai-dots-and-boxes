...
class Dots_and_Boxes:
    ...
    def __init__(self, bot1: Optional[Bot] = None, bot2: Optional[Bot] = None):
        ...
        filename = f'configs/config{len(os.listdir("./configs")) + 1}.txt'
    ...
    def mainloop(self):
        ...
        self.f.write(str(int(self.player1_turn)))
        self.f.close()
    ...
    def make_edge(self, type_, logical_position):
        self.f.write(
            f"{int(self.player1_turn)} {type_} {logical_position[0]} {logical_position[1]}\n"
        )
        if type_ == "row":
            start_x = (
